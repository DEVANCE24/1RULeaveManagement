...
namespace leavestatusmodule
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void datainput()
        {
            ...
            { 
               new internsonleave{ reason ="i have to visit a family function",day="Wed",date="16 feb",typeofleave="half day",seperatordate =" feb 2022",statusofleave="accepted",buttontext="Revoke"},
               ...
               new internsonleave{ reason ="i missed the train",day="Zumma",date="18 feb",typeofleave="full day",seperatordate =" feb 2032",statusofleave="pending",buttontext="Revoke"},
               new internsonleave{ reason ="Mood nahi hai",day="Monday",date="20 feb",typeofleave="half day",seperatordate =" feb 2032",statusofleave="accepted",buttontext="Req to revoke"},
               ...
               new internsonleave{ reason ="Dadi nahi  rahi",day="Wed",date="26 feb",typeofleave="full day",seperatordate =" feb 2032",statusofleave="pending",buttontext="Revoke"},
