...
public class AdapterMoreLeaves
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.AdapterMoreLeaves, ClgProject", AdapterMoreLeaves.class, __md_methods);
	}


	public AdapterMoreLeaves ()
	{
		super ();
		if (getClass () == AdapterMoreLeaves.class)
			mono.android.TypeManager.Activate ("ClgProject.AdapterMoreLeaves, ClgProject", "", this, new java.lang.Object[] {  });
	}
