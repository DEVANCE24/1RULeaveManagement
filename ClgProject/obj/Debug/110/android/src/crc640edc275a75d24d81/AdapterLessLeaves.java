...
public class AdapterLessLeaves
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.AdapterLessLeaves, ClgProject", AdapterLessLeaves.class, __md_methods);
	}


	public AdapterLessLeaves ()
	{
		super ();
		if (getClass () == AdapterLessLeaves.class)
			mono.android.TypeManager.Activate ("ClgProject.AdapterLessLeaves, ClgProject", "", this, new java.lang.Object[] {  });
	}
