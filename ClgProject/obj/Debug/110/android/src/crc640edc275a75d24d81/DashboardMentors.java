...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.DashboardMentors, ClgProject", DashboardMentors.class, __md_methods);
	}


	public DashboardMentors ()
	{
		super ();
		if (getClass () == DashboardMentors.class)
			mono.android.TypeManager.Activate ("ClgProject.DashboardMentors, ClgProject", "", this, new java.lang.Object[] {  });
	}


	public DashboardMentors (int p0)
	{
		super (p0);
		if (getClass () == DashboardMentors.class)
			mono.android.TypeManager.Activate ("ClgProject.DashboardMentors, ClgProject", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
