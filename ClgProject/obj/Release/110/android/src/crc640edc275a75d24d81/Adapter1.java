...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.Adapter1, ClgProject", Adapter1.class, __md_methods);
	}
	...
	public Adapter1 ()
	{
		...
		if (getClass () == Adapter1.class)
			mono.android.TypeManager.Activate ("ClgProject.Adapter1, ClgProject", "", this, new java.lang.Object[] {  });
	}

	public Adapter1 (java.lang.String[] p0)
	{
		super ();
		if (getClass () == Adapter1.class)
			mono.android.TypeManager.Activate ("ClgProject.Adapter1, ClgProject", "System.String[], mscorlib", this, new java.lang.Object[] { p0 });
	}
