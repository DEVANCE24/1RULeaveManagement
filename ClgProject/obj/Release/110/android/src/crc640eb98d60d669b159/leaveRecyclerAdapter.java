...
public class leaveRecyclerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.MentorsFile.leaveRecyclerAdapter, ClgProject", leaveRecyclerAdapter.class, __md_methods);
	}


	public leaveRecyclerAdapter ()
	{
		super ();
		if (getClass () == leaveRecyclerAdapter.class)
			mono.android.TypeManager.Activate ("ClgProject.MentorsFile.leaveRecyclerAdapter, ClgProject", "", this, new java.lang.Object[] {  });
	}
